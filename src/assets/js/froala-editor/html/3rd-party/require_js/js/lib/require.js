...
Q.test(a[l]) && (a[l] = a[l].replace(Q, '')); a[0].charAt(0) === '.' && k && (l = k.slice(0, k.length - 1), a = l.concat(a)); l = a; for (c = 0; c < l.length; c++) if (d = l[c], d === '.')l.splice(c, 1), c -= 1; else if (d === '..' && !(c === 0 || c == 1 && l[2] === '..' || l[c - 1] === '..') && c > 0)l.splice(c - 1, 2), c -= 2; a = a.join('/')
    ...
    } function d (a) { z && v(document.getElementsByTagName('script'), function (k) { if (k.getAttribute('data-requiremodule') === a && k.getAttribute('data-requirecontext') === i.contextName) return k.parentNode.removeChild(k), !0 }) } function e (a) { var k = m(j.paths, a); if (k && H(k) && k.length > 1) return k.shift(), i.require.undef(a), i.makeRequire(null, { skipMap: !0 })([a]), !0 } function n (a) { var k, c = a ? a.indexOf('!') : -1; c > -1 && (k = a.substring(0, c), a = a.substring(c + 1, a.length)); return [k, a] } function p (a,
      ...
      k, b) { var f = a.id, c = m(h, f); if (t(r, f) && (!c || c.defineEmitComplete))k === 'defined' && b(r[f]); else if (c = s(a), c.error && k === 'error')b(c.error); else c.on(k, b) } function w (a, b) { var c = a.requireModules, f = !1; if (b)b(a); else if (v(c, function (b) { if (b = m(h, b))b.error = a, b.events.error && (f = !0, b.emit('error', a)) }), !f)g.onError(a) } function x () { R.length && (ha.apply(A, [A.length, 0].concat(R)), R = []) } function y (a) { delete h[a]; delete V[a] } function F (a, b, c) {
      ...
      var a, b, c = (a = 1E3 * j.waitSeconds) && i.startTime + a < (new Date()).getTime(), f = [], l = [], g = !1, h = !0; if (!W) {
        W = !0; B(V, function (a) { var i = a.map, j = i.id; if (a.enabled && (i.isDefine || l.push(a), !a.error)) if (!a.inited && c)e(j) ? g = b = !0 : (f.push(j), d(j)); else if (!a.inited && (a.fetched && i.isDefine) && (g = !0, !i.prefix)) return h = !1 }); if (c && f.length) {
    ...
    } var W, Z, i, L, X, j = { waitSeconds: 7, baseUrl: './', paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} }, h = {}, V = {}, $ = {}, A = [], r = {}, S = {}, aa = {}, K = 1, O = 1; L = { require: function (a) { return a.require ? a.require : a.require = i.makeRequire(a.map) },
...
this.map, b = a.id, d = p(a.prefix); this.depMaps.push(d); q(d, 'defined', u(this, function (f) {
    ...
    emit: function (a, b) { v(this.events[a], function (a) { a(b) }); a === 'error' && delete this.events[a] } }; i = { config: j,
      contextName: b,
      registry: h,
      defined: r,
      urlFetched: S,
      ...
      configure: function (a) {
        a.baseUrl && a.baseUrl.charAt(a.baseUrl.length - 1) !== '/' && (a.baseUrl += '/'); var b = j.shim, c = { paths: !0, bundles: !0, config: !0, map: !0 }; B(a, function (a, b) { c[b] ? (j[b] || (j[b] = {}), U(j[b], a, !0, !0)) : j[b] = a }); a.bundles && B(a.bundles, function (a, b) { v(a, function (a) { a !== b && (aa[a] = b) }) }); a.shim && (B(a.shim, function (a, c) { H(a) && (a = { deps: a }); if ((a.exports || a.init) && !a.exportsFn)a.exportsFn = i.makeShimExports(a); b[c] = a }), j.shim = b); a.packages && v(a.packages, function (a) {
          var b,
            a = typeof a === 'string' ? { name: a } : a; b = a.name; a.location && (j.paths[b] = a.location); j.pkgs[b] = a.name + '/' + (a.main || 'main').replace(ia, '').replace(Q, '')
        }); B(h, function (a, b) { !a.inited && !a.map.unnormalized && (a.map = p(b)) }); if (a.deps || a.callback)i.require(a.deps || [], a.callback)
      },
      makeShimExports: function (a) { return function () { var b; a.init && (b = a.init.apply(ba, arguments)); return b || a.exports && da(a.exports) } },
...
!0); if (typeof c === 'string') { if (G(d)) return w(C('requireargs', 'Invalid require call'), m); if (a && t(L, c)) return L[c](h[a.id]); if (g.get) return g.get(i, c, a, j); n = p(c, a, !1, !0); n = n.id; return !t(r, n) ? w(C('notloaded', 'Module name "' + n + '" has not been loaded yet for context: ' + b + (a ? '' : '. Use require([])'))) : r[n] }J(); i.nextTick(function () { J(); q = s(p(null, a)); q.skipMap = e.skipMap; q.init(c, d, m, { enabled: !0 }); D() }); return j
          ...
          toUrl: function (b) {
            var d, e = b.lastIndexOf('.'), k = b.split('/')[0]; if (e !==
-1 && (!(k === '.' || k === '..') || e > 1))d = b.substring(e, b.length), b = b.substring(0, e); return i.nameToUrl(c(b, a && a.id, !0), d, !0)
          ...
          specified: function (b) { b = p(b, a, !1, !0).id; return t(r, b) || t(h, b) } }); a || (j.undef = function (b) { x(); var c = p(b, a, !0), e = m(h, b); d(b); delete r[b]; delete S[c.url]; delete $[b]; T(A, function (a, c) { a[0] === b && A.splice(c, 1) }); e && (e.events.defined && ($[b] = e.events), y(b)) }); return j
      },
      enable: function (a) { m(h, a.id) && s(a).enable() },
      completeLoad: function (a) {
        var b,
          c, d = m(j.shim, a) || {}, g = d.exports; for (x(); A.length;) { c = A.shift(); if (c[0] === null) { c[0] = a; if (b) break; b = !0 } else c[0] === a && (b = !0); E(c) }c = m(h, a); if (!b && !t(r, a) && c && !c.inited) { if (j.enforceDefine && (!g || !da(g))) return e(a) ? void 0 : w(C('nodefine', 'No define call for ' + a, null, [a])); E([a, d.deps || [], d.exportsFn]) }D()
      },
      ...
      onScriptLoad: function (a) { if (a.type === 'load' || ja.test((a.currentTarget || a.srcElement).readyState))N = null, a = I(a), i.completeLoad(a.id) },
